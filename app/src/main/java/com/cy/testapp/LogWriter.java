...
public class LogWriter {
	...
	private static com.cy.testapp.LogWriter mLogWriter;
	...
	public static com.cy.testapp.LogWriter open(String file_path) throws IOException {
		if (mLogWriter == null) {
			File file=new File(file_path);
			File[] files= file.listFiles();
			String fileName= file_path+"/"+UtilContext.getContext().getPackageName()+"."
...
//			}
//			if (mLogWriter==null){
				mLogWriter = new com.cy.testapp.LogWriter(fileName);
//			}
